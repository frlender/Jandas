...
var Series = /** @class */ (function () {
    function Series(first, second, third) {
        ...
        switch (true) {
            case second === undefined && third === undefined:
                this.name = '';
                this.index = new Index_1.default(this.values.map(function (_, i) { return i; }));
                break;
            ...
            case third === undefined:
                this.name = '';
                this.index = second instanceof Index_1.default ? second : new Index_1.default(second);
                break;
            default:
                this.name = third;
                this.values = first;
    ...
    Series.prototype._iloc = function (idx) {
        switch (true) {
            case idx === undefined:
                return new Series((0, cmm_1.cp)(this.values), this.index.cp(), this.name);
    ...
    Series.prototype.loc = function (index) {
        var num_idx = (0, cmm_1._trans)(this.index, index);
    ...
    Series.prototype.value_counts = function () {
        ...
        var df = new DataFrame_1.default(pairs, null, ['value', 'count']);
